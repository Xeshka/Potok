...
import ru.kolesnik.potok.core.ui.assignees.AssigneesList
import ru.kolesnik.potok.core.ui.assignees.TaskTitleField
...
fun InputFieldsSection(
    ...
    Column(modifier = Modifier.padding(horizontal = 16.dp)) {
        ...
        AssigneesList(assignees = task?.assignees ?: emptyList(), employees)
